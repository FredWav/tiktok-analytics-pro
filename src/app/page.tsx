    ...
    <div className="min-h-screen w-full max-w-4xl mx-auto p-4 md:p-8">
      <header className="text-center mb-10">
        ...
        <p className="text-gray-400 mt-2">
          Collez l'URL d'une vidéo pour obtenir ses statistiques publiques.
        </p>
      </header>
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="bg-[#161b22] border border-gray-700 rounded-2xl p-6 flex flex-col md:flex-row gap-6">
        {data.video.thumbnail && (
          <img src={data.video.thumbnail} alt="Video thumbnail" className="w-40 h-56 object-cover rounded-lg self-center md:self-start border border-gray-700"/>
        )}
